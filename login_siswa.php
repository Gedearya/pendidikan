                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form method="POST">
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Login Siswa - SMA Digitalent</h5>
                                        ...
                                        <p class="pb-lg-2" style="color: #393f81;">Don't have an account? <a href="register_siswa.php" style="color: #393f81;">Register here</a></p>
                                    </form>
                                    <?php
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $query = $conn->query("SELECT username FROM tb_user WHERE username = '$username' AND password = '$password' ");
